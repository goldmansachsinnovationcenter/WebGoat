  ...
  protected AttackResult injectableQuery(String login_count, String accountName) {
    ...
    try (Connection connection = dataSource.getConnection()) {
        ...
        return failed(this)
            .output(
                "Could not parse: "
                    ...
                    + " to a number"
                    + "<br> Your query was: "
                    + queryString + " [" + login_count + ", " + accountName + "]")
            .build();
      }
      ...
      try {
        ...
        if ((results != null) && (results.first() == true)) {
          ...
          if (results.getRow() >= 6) {
            return success(this)
                ...
                .output("Your query was: " + queryString + " [" + login_count + ", " + accountName + "]")
        ...
        return failed(this)
            .output(
                sqle.getMessage() + "<br> Your query was: " + queryString + " [" + login_count + ", " + accountName + "]")
            .build();
      }
    } catch (Exception e) {
      return failed(this)
